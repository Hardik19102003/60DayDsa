...
//    }
//
//    int countNodesGreater(Node root,int key){
//        if(root==null){
//            return 0;
//        }
//
////        Value at the current node is equal to Key
////        means All right side nodes are greater than current node
//        if(root.key==key){
//            return countNodes(root.right);
//        }
////        Value at the current node is greater than Key
////        Means All right side nodes are greater including current node
//        else if(root.key>key){
//            int sum = countNodes(root.right)+1;
//            sum += countNodesGreater(root.left,key);
//            return sum;
//        }
////        Value at the current node is smaller than key
////        means we can move to the right
//        else{
//            return countNodesGreater(root.left,key);
//        }
//    }
//
//
...
//        System.out.println();
//        System.out.println(avl.countNodesGreater(avl.root,4) + " : Nodes are Greater than 4");
//
//        avl.deleteNode(avl.root,2);
//        System.out.println("\n \nIn order Traversal after delete 2 : ");
//        avl.inOrder(avl.root);
//        System.out.println();
//        System.out.println(avl.countNodesGreater(avl.root,1) + " : Nodes are Greater than 1 after deletion");
//
//        avl.deleteNode(avl.root,11);
//        System.out.println("\n \nIn order Traversal after delete 11 : ");
//        avl.inOrder(avl.root);
//        System.out.println();
//        System.out.println(avl.countNodesGreater(avl.root,4) + " : Nodes are Greater than 4 after deletion\n");
//
//    }
//}
